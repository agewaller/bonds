...
## 一般解を出さない — 必ずユーザーに寄せる（2026-07-19 オーナー宣言・恒久・全サービス共通）

このサービス（およびオーナーが創るすべてのサービス）は、誰にでも当てはまる一般解・
教科書的な回答を出さない。回答の中身も、文体・トーンも、必ずそのユーザーひとりの
価値観・気持ち・特殊事情に寄せる。

- 中身: 一般論で終わらせず、その人の状況・価値観・制約・目的にひきつけた具体で答える。
- 文体・トーン: その人の気持ちと事情に寄り添った言い回しにする。冷たい定型文や、
  当てはまりの悪い決まり文句を使わない。
- 自己点検: 出す前に「これは誰にでも言える一般解になっていないか」を必ず確かめ、
  なっていれば、その人に寄せて書き直す。

この原則は、ユーザーに向かうすべての出力（画面の文言・提案・生成文・レポート・返信）に
適用する。
